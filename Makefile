...
#    Updated: 2024/12/13 03:35:45 by yenyilma         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
B_SRC			=	checker_bonus.c data_parser_bonus.c ft_lstsort_bonus.c ft_stackclear_bonus.c ft_stacknew_bonus.c \
					...
					rotate_operations_bonus.c stack_help_bonus.c swap_operations_bonus.c target_bonus.c transaction_bonus.c
...
$(NAME) : $(LIBFT) $(PRINTF) $(OBJ) $(HEADER)
	...
	@echo "$(COLOR_GREEN)push_swap successfully compiled...$(COLOR_RESET)"
...
$(CHECKER) : $(LIBFT) $(PRINTF) $(GNL) $(B_OBJ) $(B_HEADER)
	...
	@echo "$(COLOR_PURPLE)checker successfully compiled...$(COLOR_RESET)"
...
fclean :
	...
	@echo "$(COLOR_RED)cleaned object files and executables$(COLOR_RESET)"

re : fclean all
	@echo "$(COLOR_GREEN)Recompiled$(COLOR_RESET)"